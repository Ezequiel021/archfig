    ...
    PopupWindow {
        ...
        Item {
            ...
            Rectangle {
                ...
                // El ancho dinámico sigue animándose
                width: wifi.isHovered ? 260 : tooltipTextDisplay.implicitWidth + 24
                ...
                Wifi {
                    id: wifiWidget
                    // 2. En lugar de anclarse a los lados (anchors.fill), le damos el tamaño final fijo.
                    // Así, el RowLayout interno no se recalcula durante la animación; simplemente se va "revelando".
                    anchors.top: parent.top
                    anchors.bottom: parent.bottom
                    anchors.left: parent.left
                    width: 260 
