    ...
    PopupWindow {
        ...
        Item {
            ...
            Rectangle {
                ...
                width: {
                    if (wifi.isHovered) {
                        return 260; // Ancho fijo e ideal para acomodar la lista de redes
                    }
                ...
                Text {
                    ...
                    text: {
                        if (battery.isHovered)
                            return battery.tooltipText
                        if (wifi.isHovered)
                            return wifi.tooltipText
                        if (bluetooth.isHovered)
                            return bluetooth.tooltipText
                        return "Error!"
                    }
