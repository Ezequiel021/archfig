...
\begin{enumerate}
    ...
    \begin{enumerate}[label={(\roman*)}]
        ...
        \begin{itemize}
            ...
            \]
            \item Dado que \(a \geq 0\), entonces la monotonicidad del primer término \(aF(x)\) es igual a la de \(F(x)\), que es creciente por hipótesis. De forma similar, como \(a \leq 1\), entonces \((1 - a) \geq 0\), por lo que el término \((1 - a)G(x)\) es creciente también. Dado que la suma de funciones crecientes es creciente, se sigue que la función \(aF(x) + (1 - a)G(x)\) es creciente.
