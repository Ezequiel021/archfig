...
\begin{enumerate}
    ...
    \begin{enumerate}[label={(\roman*)}]
        ...
        \begin{itemize}
            ...
            \]
            \item Dado que \(a \geq 0\), entonces la monotonicidad del primer término \(aF(x)\) es igual a la de \(F(x)\), que es creciente por hipótesis. De forma similar, como \(a \leq 1\), entonces \((1 - a) \geq 0\) y el término \((1 - a)G(x)\) también es creciente. Como la suma de funciones crecientes también es creciente, se sigue que la función \(aF(x) + (1 - a)G(x)\) es creciente.
            ...
            \]
        \end{itemize}
        Como hemos verificado las propiedades, entonces la función \(aF(x) + (1 - a)G(x)\) es una función de distribución.
    ...
    \item \begin{itemize}
        ...
        \]
        Ya que \(F\) y \(G\) son funciones de distribución, su límite cuando \(x\) tiende a infinito negativo es 0, por loq eu al evaluar el límite tenemos:
        \[
        \lim_{x \to -\infty}F(x)G(x) = (0)(0) = 0.
        \]
        De igual manera, cuando \(x\) tiende a infinito positivo, el límite de \(F\) y \(G\) es 1. Entonces,
        \[
        \lim_{x \to +\infty}F(x)G(x) = (1)(1) = 1.
        \]
        \item Ya que el producto de funciones positivas preserva la monotonicidad, \(F(x)G(x)\) es creciente.
    \end{itemize}
    \item a
\end{enumerate}
\end{enumerate}
