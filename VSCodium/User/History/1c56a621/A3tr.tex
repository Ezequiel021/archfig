...
\[
\boxed{\Int(\Omega) = \{ (x,y,z)\in \R^3 : 0 < x < 1, \ y^2+z^2 < 1 \}.}
\]

Este conjunto es un ``cilindro sólido abierto'' de radio 1, con eje en el eje $x$, y con tapas abiertas en $x=0$ y $x=1$.
