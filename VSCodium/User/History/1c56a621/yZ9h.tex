...
\[
\boxed{\overline{\Omega} = \{ (x,y)\in \R^2 : x \geq y^2 \}.}
\]

\textbf{Interpretación geométrica:}

El conjunto $\Omega$ es la región del plano que se encuentra estrictamente a la derecha de la parábola $x = y^2$ (que abre hacia la derecha). Su cerradura es esa misma región, pero incluyendo la parábola como frontera.
