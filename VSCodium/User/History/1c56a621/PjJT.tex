...
\textbf{Solución: } Recordemos que la frontera de un conjunto $\Omega$, denotada por $\partial \Omega$, se define como
\[
\partial \Omega = \overline{\Omega} \setminus \Int(\Omega),
\]
donde $\overline{\Omega}$ es la cerradura de $\Omega$ e $\Int(\Omega)$ es su interior.

Alternativamente, un punto $\mathbf{p} \in \R^2$ pertenece a la frontera de $\Omega$ si toda bola abierta centrada en $\mathbf{p}$ contiene tanto puntos de $\Omega$ como puntos del complemento de $\Omega$.
...
\textbf{Paso 1: Determinar el interior y la cerradura.}

Dado que $f$ es continua, el conjunto $\Omega = f^{-1}((1, \infty))$ es abierto. Por lo tanto, $\Int(\Omega) = \Omega$. Es decir,
\[
...
\textbf{Paso 2: Calcular la frontera.}

Usando la definición de frontera como $\partial \Omega = \overline{\Omega} \setminus \Int(\Omega)$, tenemos:
\[
...
\[
\boxed{\partial \Omega = \{ (x,y)\in \R^2 : x^2 - y^2 = 1 \}.}
\]

\textbf{Interpretación geométrica:}

La ecuación $x^2 - y^2 = 1$ describe una hipérbola con centro en el origen, cuyo eje focal es el eje $x$. Sus asíntotas son las rectas $y = x$ e $y = -x$. Los vértices de la hipérbola están en los puntos $(-1,0)$ y $(1,0)$. La frontera del conjunto $\Omega$ es exactamente esta hipérbola.
