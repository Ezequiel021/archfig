...
Item {
    ...
    implicitWidth: colLayout.implicitWidth + (Tokens.containerMargins * 2)
    implicitHeight: colLayout.implicitHeight + (Tokens.containerMargins * 2)
    ...
    ColumnLayout {
        ...
        Repeater {
            ...
            delegate: Item {
                ...
                property bool isActive: modelData.active && modelData.monitor === root.currentMonitor

                visible: modelData.monitor === root.currentMonitor
                ...
                Button {
                    ...
                    icon {
                        width: 15
                        height: 15
                        source: (modelData.toplevels.values.length > 0 || modelData.active) ? "" : Quickshell.iconPath("media-record-symbolic")
                        
                        // Animate icon color changes smoothly
                        color: delegateItem.isActive ? Theme.on_primary : Theme.on_primary_container
