                ...
                Button {
                    ...
                    background: Rectangle {
                        ...
                        color: {
                            ...
                            if (modelData.is_active) return Theme.color.surface; // Azul: Tag actual enfocado
                    ...
                    palette.buttonText: (modelData.is_active) ? Theme.on_Primary : Theme.oNPrimaryContainer
