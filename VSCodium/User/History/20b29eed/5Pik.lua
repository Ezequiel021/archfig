...
hl.bind(mainMod .. " + M", hl.dsp.exec_cmd(defaults.logout))
hl.bind(mainMod .. " + E", hl.dsp.exec_cmd(defaults.fileManager))
hl.bind(mainMod .. " + R", hl.dsp.exec_cmd(defaults.menu))
hl.bind(mainMod .. " + C", hl.dsp.exec_cmd(defaults.editor))
hl.bind(mainMod .. " + B", hl.dsp.exec_cmd(defaults.browser))
hl.bind(mainMod .. " + L", hl.dsp.exec_cmd(defaults.lock))

hl.bind(mainMod .. " + Q", hl.dsp.window.close())
hl.bind(mainMod .. " + F", hl.dsp.window.fullscreen())
hl.bind(mainMod .. " + V", hl.dsp.window.float({ action = "toggle" }))
hl.bind(mainMod .. " + lsuper", hl.dsp.exec_cmd("qs ipc call launcher toggle"))
